...
function withResizeDetector(ComponentInner) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var ResizeDetectorHOC = /*#__PURE__*/function (_Component) {
    function ResizeDetectorHOC() {
      ...
      _this = _callSuper(this, ResizeDetectorHOC, [].concat(args));
      _this.ref = /*#__PURE__*/createRef();
      return _this;
    }
    _inherits(ResizeDetectorHOC, _Component);
    return _createClass(ResizeDetectorHOC, [{
      key: "render",
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement(ResizeDetector, _extends({}, options, {
          targetRef: targetRef
        }), /*#__PURE__*/React.createElement(ComponentInner, _extends({
          targetRef: targetRef,
          ref: forwardedRef
        }, rest)));
      }
