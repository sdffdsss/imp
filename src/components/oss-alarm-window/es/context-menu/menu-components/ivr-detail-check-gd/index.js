...
import { rightClickViewPageArgs, rightClickShow4 } from '../../../alarm-window/alarm-show-config';
...
var Component = function Component(props) {
  ...
  var alarmInfoColumns = rightClickShow4.map(function (item) {
    return {
      title: item.label,
