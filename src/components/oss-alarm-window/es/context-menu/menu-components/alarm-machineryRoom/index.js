...
import { mrViewPageArgs, mrViewPageArgsUnicom } from '../../../alarm-window/alarm-show-config';
import { getViewItemData } from '../../../alarm-window/common/proxy';
import dmDef from '../alarm-devResInfo/dataModelDefinition.json';
import { _ } from 'oss-web-toolkits';
var CompMachineryRoom = function CompMachineryRoom(props) {
  var menuInfo = props.menuInfo;
  ...
  var loadData = function loadData(alarmClickTarget) {
    ...
    setLoading(true);
    var viewPageArgs = {};
    var args = menuInfo.key === 'CompMachineryRoomUnicom' ? mrViewPageArgsUnicom : mrViewPageArgs;
    ...
    if (menuInfo.key === 'CompMachineryRoomUnicom') {
      viewPageArgs.object_class = '10005';
    }
    var viewItemId = menuInfo.key === 'CompMachineryRoomUnicom' ? dmDef.dataModelDefinition.name : 'alarm-machine-roomInfo';
...
export default CompMachineryRoom;