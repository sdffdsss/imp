...
var CompEffectedCell = function CompEffectedCell(props) {
  ...
  var handleDownloadClick = function handleDownloadClick() {
    ...
    var callback = function callback(result) {
      if (result.success) {
        ...
        // downloadLink.download = `导出影响小区数据${dayjs().format('YYYYMMDDHHmmss')}.xls`;
        // // 触发点击事件执行下载
        // downloadLink.click();
...
export default CompEffectedCell;