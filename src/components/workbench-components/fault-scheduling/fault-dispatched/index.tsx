...
import './style.less';
const FaultDispathched = ({ viewData, onResultChange, provinceList }) => {
    ...
    useEffect(() => {
        ...
        if ((userInfos.zoneLevel === '2' && userInfos.zoneId) || (userInfos.zoneLevel === '3' && userInfos.parentZoneId)) {
            conditionList.current = [
                ...
                },
                {
                    ...
                    value: [userInfos.zoneLevel === '3' ? userInfos.parentZoneId : userInfos.zoneId],
                    not: false,
                },
            ];
        }
