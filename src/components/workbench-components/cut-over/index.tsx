...
const DialTest = () => {
    return (
        <div className="cut-over-continer">
            {/* <div className="title">
                重保总结
                ...
                <div className="demo-left">
                            ...
                            format={() => {
                                return (
                                    <div className="view-component-home-page-tabs-progress-content">
                                        <div style={{ fontSize: '1.6vh', color: 'rgba(144,152,174)' }}>所有割接</div>
                    ...
                    <div className="left-title">
                        <div className="button-name">
                            <div className="name">往日割接</div>
                            <div className="num">1</div>
                        </div>
                        <div className="button-name">
                            <div className="name">已确认</div>
                            <div className="num">1</div>
                        </div>
                        <div className="button-name">
                            <div className="name">已反馈</div>
                            <div className="num">1</div>
                        </div>
                    </div>
                </div>
