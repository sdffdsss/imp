...
class Index extends React.PureComponent {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.height !== this.props.height || prevProps.selectedRows !== this.props.selectedRows) {
            this.generateView();
        }
    ...
    componentWillUnmount() {
        ...
        GlobalMessage.off('activeChanged', this.handleTabActiveChange, null);
    }

    handleTabActiveChange = ({ isActive }) => {
        if (isActive) {
    ...
    watchTabActiveChange = () => {
        GlobalMessage.off('activeChanged', this.handleTabActiveChange, null);
        GlobalMessage.on('activeChanged', this.handleTabActiveChange);
    };
                ...
                actions.postMessage(messageTypes.closeTabs, {
                    entry:
                        windowTypeEnum.DUTY === windowType
                            ? `/unicom/home-unicom/alarm-window-unicom/duty-window`
                            : `/unicom/home-unicom/alarm-window-unicom/custom-window`,
                });
            }
        } else {
