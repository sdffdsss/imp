...
class Index extends React.PureComponent {
            ...
            },
            {
                ...
                renderFormItem: () => {
                    return (
                        ...
                        >
                            <Input placeholder="请输入手机号，多个请用逗号隔开" allowClear />
                        </Form.Item>
                    );
                },
            },
                    ...
                    return (
                        <Space>
                            {/* {row.status === 3 && (
                                <Popconfirm
                                    title="确认重新发送此条短信吗?"
                                    onConfirm={this.sentHandler.bind(this, row)}
                                    okText="确认"
                                    cancelText="取消"
                                >
                                    <Tooltip title="重新发送">
                                        <Icon type="MailOutlined" antdIcon />
                                    </Tooltip>
                                </Popconfirm>
                            )} */}
                            <Tooltip title="复制">
                                <Icon type="CopyOutlined" antdIcon onClick={this.showEditModal.bind(this, row)} />
                            </Tooltip>
    ...
    sentHandler = (row) => {
        request('manualShortNote/reSendShortNote', {
            type: 'get',
    ...
    getListHandler = (params) => {
        ...
        sendLogFn({ authKey: 'workbenches:sendedQuery' });
    ...
    showEditModal = (row) => {
        ...
        sendLogFn({ authKey: 'workbenches:sendedCopy' });
    ...
    deleteHandler = (row) => {
        ...
        sendLogFn({ authKey: 'workbenches:sendedDelete' });
