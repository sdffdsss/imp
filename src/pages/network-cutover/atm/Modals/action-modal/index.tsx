...
import { MODAL_TYPE, MODAL_TYPE_NAME, ALL_ENUMS, YES_NO_OPTION, MAJOR_ENUM, ActionType } from '../../../type';
    ...
    const onFinish = async (values: any) => {
        try {
            ...
            const params = {
                ...
                cutoverStartTime: moment(values.cutoverStartTime).format('YYYY-MM-DD HH:mm:ss'),
                cutoverEndTime: moment(values.cutoverEndTime).format('YYYY-MM-DD HH:mm:ss'),
            };
            if (openId && openId !== 0) {
                // 更新
                            ...
                            <Row gutter={24}>
                                ...
                                <Col span={8}>
                                    <Form.Item label="专业" name="professionType">
                                        <Select disabled placeholder="请选择专业" options={formatOption(enums.professionalEnum, [MAJOR_ENUM.ATM])} />
                                    </Form.Item>
                                </Col>
                                ...
                                <Col span={8}>
                                    <Form.Item label="操作单位" name="departmentName">
